...
class MiniCourt():
    ...
    def draw_court(self, frame):
        ...
        for line in self.lines:
            point1 = (int(self.drawing_key_points[line[0]*2]), int(self.drawing_key_points[line[0]*2+1]))
            point2 = (int(self.drawing_key_points[line[1]*2]), int(self.drawing_key_points[line[1]*2+1]))
    ...
    def get_mini_court_coordinates(self, object_position, closest_key_point, 
                                   closest_key_point_index, player_height_in_pixels, player_height_in_meters):
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_keypoints):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            closest_player_id_to_ball = min(player_bbox.keys(), key=lambda x: calculate_distance(ball_position, get_foot_position(player_bbox[x])))
